...
- PR 템플릿을 잘 활용하자
  ...
  <img src="https://github.com/programmer-sjk/TIL/blob/main/images/culture/prtemplate.png" width="500">

### 개선이 필요한 이유에 대해 충분한 설명을 한다

- 리뷰어가 코드 개선의 필요성을 느끼고 리뷰를 남긴다면 충분한 이유가 뒷받침되어야 한다. 만약 코드 리뷰가 주관적이거나 추상적이라면 리뷰이는 혼란을 느낄 수 있습니다.
